    ...
    WebtoonDetails: [
        {
            ...
            author: '저자 1',
            platform: '네이버',
            imageLink: require('../../assets/banner/banner4.jpg')
        },
        {
            ix: 2,
            genre: '#개그 #시대극',
            ...
            author: '저자 2',
            platform: '레진코믹스',
            imageLink: require('../../assets/banner/banner2.jpg')
        },
        {
            ix: 3,
            genre: '#개그',
            ...
            author: '저자 3',
            platform: '다음',
            imageLink: require('../../assets/banner/banner3.jpg')
        },
        {
            ix: 4,
            genre: '#시대극',
            ...
            author: '저자 4',
            platform: '다음',
            imageLink: require('../../assets/banner/banner1.jpg')
        },
        {
            ix: 5,
            genre: '#개그 #시대극',
            ...
            author: '저자 5',
            platform: '네이버',
            imageLink: require('../../assets/banner/banner5.jpg')
        }
    ],
